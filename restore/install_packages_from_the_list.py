...
def check_if_system_is_macos():
    return os.path.isfile("/etc/os-release") and "macos" in open("/etc/os-release", "r").read()
...
# install packages in text file where each line contains a package name. Return list of successfully installed packages and list of packages unable to install. Display progressbar
def install_packages(packages_file, operating_system):
    packages_installed = []
    packages_not_installed = []
    if operating_system == "linux":
        packages_installed, packages_not_installed = install_packages_linux(packages_file)
    elif operating_system == "macos":
        packages_installed, packages_not_installed = install_packages_macos(packages_file)
...
def __main__():
    ...
    packages_installed, packages_not_installed = install_packages("packages.txt", operating_system)
