...
#
# ticker.sh is a simple shell script using the Yahoo Finance API as a data source.
# It features colored output and is able to display pre- and post-market prices.
